...
const HomePage = () => {
    ...
    const signup = async () => {
        try {
            const response = await axios.post("https://video-call-server-pink.vercel.app/signup", { email: email, password: password })
    ...
    const login = async () => {
        try {
            const response = await axios.post("https://video-call-server-pink.vercel.app/login", { email: email, password: password })
            const data = response.data
            console.log(data)
            if (data.error) {
                alert(data.error)
